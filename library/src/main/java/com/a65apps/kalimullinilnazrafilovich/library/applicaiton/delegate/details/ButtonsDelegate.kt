...
class ButtonsDelegate(
    ...
    private fun setStatusToggleBtn(
        ...
        birthdayNotification = viewModel.getBirthdayNotification(contactDetailsInfo)
    ...
    override fun onCheckedChanged(
        ...
        birthdayNotification = viewModel.setBirthdayNotification(contactDetailsInfo)
        birthdayNotification.observe(lifecycleOwner, Observer {
        })
    } else {
        birthdayNotification = viewModel.removeBirthdayNotification(contactDetailsInfo)
        birthdayNotification.observe(lifecycleOwner, Observer { })
    }
